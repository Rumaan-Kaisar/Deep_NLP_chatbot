...
def decoder_rnn(decoder_embeded_input, decoder_embedding_matrix, encoder_state, num_words, sequence_length, rnn_size, num_layers, word2int,  keep_prob, batch_size):
...
keep_probability = 0.5  # optimal accordinf to Hinton
